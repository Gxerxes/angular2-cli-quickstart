...
import {BaCardBlurHelperService} from './ba-card-blur-helper.service';
import {BgMetrics} from './bgMetrics';
import {BaThemeConfigProvider} from "../theme.configProvider";

@Directive({
  selector: '[baCardBlur]',
  providers: [BaCardBlurHelperService, BaThemeConfigProvider]
})
export class BaCardBlur {
  ...
  constructor(private _baConfig:BaThemeConfigProvider, private _baCardBlurHelper:BaCardBlurHelperService, private _el:ElementRef) {
    if (this._isEnabled()) {
